...
<div style="width: 100%;height: 150px;overflow-y:auto;border: 1px solid #ccc;padding: 10px 20px;font-size: 16px;">
<?php echo "<p>".$getcat['groupDescription']."</p><br>";?>
</div>
<p style="margin: 25px 0px;font-weight: 600;font-size: 16px;">Group Admin Name</p>
<div style="width: 100%;max-height: 137px;overflow-y:auto;border: 1px solid #ccc;padding: 10px 20px;font-size: 16px;margin: 10px 0px;">
<?php
...
<div style="width: 30%;max-height: 137px;overflow-y:auto;border: 1px solid #ccc;padding: 10px 20px;font-size: 16px;float:left">
<h6>LOCATIONS</h6><hr>
<?php
