...
<div id="testpopup" style="background-color:#ffffff !important;    box-shadow: 1px 1px 5px 1px #888888;margin-top:28px;">
    ...
    <div style="width: 222px;
        ...
        <button  id="close_news_priview" type="button"class="btn btn-gray" style="    margin-left: 221px;
                 margin-top: -50px;">X</button><br><br>
                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-7 col-sm-7 col-md-7 col-xs-7">
                                <div class="form-group">
                                    ...
                                    <textarea style="color:#2d2a3b;" class="form-control" name="content" id="content" rows="7" placeholder="Choose a caption for this image..." ></textarea>
                                </div>
                            </div>
                        ...
                        <div class="publication" style="margin-top:20px;">
                            ...
                            <div class="publication"><p id="publication_heading">Options</p><hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"id="rightpublicationdiv6">
                                        ...
                                        <div class="checkbox"style="margin-top:-10px;"><label><input style="color:#2d2a3b;" type="checkbox" data-toggle="toggle" name="comment" value="COMMENT_YES" checked></label></div>
                            ...
                            <div class="publication"><p id="publication_heading">Notification</p><hr>
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-xs-6 col-sm-6 col-md-6 col-lg-6"id="rightpublicationdiv6">
                                        <div class="checkbox"style="margin-top:-10px;"><label><input style="color:#2d2a3b;" type="checkbox" data-toggle="toggle" name="push" value="PUSH_YES" checked></label></div>
