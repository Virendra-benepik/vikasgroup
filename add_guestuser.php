            ...
            <div class="card">
                <div class="card-header">
                    <div class="card-title">
                        <div class="title"><strong>Guest User Details</strong></div>
                    </div>
                </div>
                <div class="card-body">
                    <div class="step">
                            ...
                            <li role="step" class="active">
                                <a href="#step1" id="step1-tab" role="tab" data-toggle="tab" aria-controls="home" aria-expanded="true">
                                    ...
                                    <div class="step-title">
                                        ...
                                        <div class="description">If Multiple Guest User then Upload CSV File </div>
                                    </div>
                                </a>
                            </li>
                           <!-- <li role="step">
                                <a href="#step2" role="tab" id="step2-tab" data-toggle="tab" aria-controls="profile">
                                    ...
                                    <div class="step-title">
                                        ...
                                        <div class="description">If Single Guest User Then Fill Form</div>
                                    </div>
                                </a>
                            </li>
							-->
                                    ...
                                    <div class="col-sm-12">
                                        <div class="col-sm-6 col-sm-offset-2">
                                            <div class="panel panel-success">
                                                <div class="panel-heading">Upload Guest User Details</div>
                                                <div class="panel-body">
                                                    <div class="text-center" style="border:1px solid #e6e6e6; box-shadow:0 1px 5px rgba(0, 0, 0, 0.1); padding:10px;">
                                                        <form role="form" name="csvform" method="post" enctype="multipart/form-data" action="Link_Library/link_client_guestUser.php" onsubmit="return check()">
                                        ...
                                        <span style="    position: absolute;
                                              ...
                                              right: 9%;
                                              bottom: 15%;
                                              text-decoration: underline;"><a href="demoCSVfile/guestuserDemoCSV.csv"> Download CSV file format</a></span>
                                    </div>
                                </div>
                            </div>
                            <div role="tabpanel" class="tab-pane fade" id="step2" aria-labelledby="profile-tab">

                                <form method="post" name="adduserform" action="Link_Library/link_client_guestUser.php" onsubmit="return check()">
                                    <div class="row">
                                    ...
                                    <div class="row">
                                       ...
                                       <input  style="color:#2d2a3b;" type="text" name="companyname" class="form-control" id="exampleInputPassword1" placeholder="Enter Company Name">
                                        </div>
                                        <div class="form-group col-sm-4">
