...
<div class="side-body">
    ...
    <td  style="width:16% !important;"><!--<a onClick="javascript:if(confirm('Are you sure want to Delete Post ?')){return true;} else{return false}" href="Link_Library/delete_post.php?idpost=<?php echo $val[$i]['post_id']; ?>&page=picture">	<button type="button"class="btn btn-sm  btn-danger"><span class="glyphicon glyphicon-trash"></span>  Delete</button></a>-->
									...
									<a target="_blank" href="update_picture.php?idpost=<?php echo $val[$i]['post_id']; ?>&page=picture" style="color:#00a4fd;margin-left:29px !important;">Edit</a>
									
                                    <a href="Link_Library/link_post_status.php?postid=<?php echo $val[$i]['post_id']; ?>&poststatus=<?php echo $val[$i]['status']; ?>&page=picture" style="color:#CE3030;margin-left:30px !important"><?php echo $action; ?></a>
